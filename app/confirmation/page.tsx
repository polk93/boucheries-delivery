    ...
    <div className="min-h-screen bg-creme flex flex-col" style={{ paddingBottom: 40 }}>
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4 w-full">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm text-center">
          ...
          <h2 className="font-serif text-xl font-black text-brun mb-1">Merci pour votre commande !</h2>
          <p className="text-sm text-gray-400 mb-4">Votre boucherie prépare tout pour vous.</p>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm space-y-3">
          <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Détails du retrait</p>

          <div className="flex gap-3 items-start">
            <div className="w-10 h-10 bg-brun rounded-xl flex items-center justify-center text-lg flex-shrink-0">🔪</div>
            <div>
              <p className="text-sm font-bold text-brun">{boucherie?.nom || 'Votre boucherie'}</p>
              <p className="text-xs text-gray-400 mt-0.5">{infos.adresse}</p>
            </div>
          </div>
