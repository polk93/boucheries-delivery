      ...
      <div className="fixed inset-0 bg-black/65 z-[200] flex items-center justify-center p-4" onClick={onClose}>
        <div className="bg-white rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
          ...
          <div className="p-5 space-y-4">
            ...
            {/* Rôle */}
            <div>
              <p className="text-base font-bold text-brun mb-2">Je suis…</p>
            ...
            {!(tab === 'register' && role === 'boucher') && (
              <>
                <div className="space-y-3">
                  {tab === 'register' && (
                    <div>
                      <label className="text-base font-bold text-brun block mb-1">Prénom & Nom</label>
                  ...
                  <div>
                    <label className="text-base font-bold text-brun block mb-1">Email</label>
                  ...
                  <div>
                    <label className="text-base font-bold text-brun block mb-1">Mot de passe</label>
                ...
                {error && (
                  <div className="bg-rouge-pale border border-rouge-vif/20 rounded-xl px-3 py-2">
                    <p className="text-rouge-vif text-base font-semibold">⚠️ {error}</p>
                  </div>
                )}
                ...
                <div className="border-t border-gris-bd pt-3">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 bg-creme border border-gris-bd text-brun font-bold py-2 rounded-xl text-base font-sans"
                      onClick={() => { login(DEMO_CLIENT); onClose(); router.refresh() }}>
                      🛒 Client démo
                    </button>
                    <button className="flex-1 bg-or-pale border border-or/30 text-brun font-bold py-2.5 rounded-xl text-base font-sans"
