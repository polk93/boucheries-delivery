      ...
      <div className="max-w-lg mx-auto px-4 py-5 space-y-4">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm space-y-3">
          ...
          <div className="flex gap-2">
            <a href={`https://wa.me/?text=${encodeURIComponent(`🥩 Commande chez ton boucher artisan avec Côtes à Côte ! -5€ avec mon code : ${lien}`)}`}
              target="_blank" rel="noopener noreferrer"
              className="flex-1 bg-green-500 text-white py-2.5 rounded-xl text-xs font-bold text-center no-underline font-sans">
              📱 WhatsApp
            </a>
            <a href={`sms:?body=${encodeURIComponent(`Essaie Côtes à Côte, -5€ avec mon code : ${lien}`)}`}
