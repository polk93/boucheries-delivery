...
export const BOUCHERIES: Boucherie[] = [
  {
    ...
    produits: [
      { id: 'e1', nom: 'Entrecôte Charolais', desc: '500g, persillé idéal', prix: 18.90, icon: '🥩', stock: 12,
      ...
      { id: 'f1', nom: 'Filet de Bœuf', desc: '300g, ultra tendre', prix: 24.50, icon: '🍖', stock: 5,
      ...
      { id: 'b1', nom: "Bavette d'Aloyau", desc: '400g, goûteuse', prix: 12.80, icon: '🥩', stock: 0,
        photo: null, decoupes: ['Standard', 'Fine', 'Épaisse'], preparation: ['Nature', 'Marinée échalotes'] },
      { id: 'm1', nom: 'Merguez Maison', desc: '6 pièces, épicées', prix: 8.50, icon: '🌶️', stock: 22,
  ...
  },
  {
    ...
    produits: [
      { id: 'cv1', nom: 'Côte de Veau', desc: '500g, Label Rouge', prix: 21.00, icon: '🥩', stock: 6,
        photo: null, decoupes: ['Avec os', 'Désossée', 'Escalope fine'], preparation: ['Nature', 'Milanaise', 'À la crème'] },
      { id: 'ev1', nom: 'Escalope de Veau', desc: '2 pièces, 300g', prix: 14.60, icon: '🍖', stock: 0,
        photo: null, decoupes: ['Fine (5mm)', 'Épaisse (1cm)'], preparation: ['Nature', 'Panée', 'Saltimbocca'] },
      { id: 'nv1', nom: 'Noix de Veau', desc: '400g, rôti idéal', prix: 19.90, icon: '🥩', stock: 4,
        photo: null, decoupes: ['Entière', 'En tranches', 'En cubes'], preparation: ['Nature', 'Bardée lard', 'Farcie'] },
      { id: 'ov1', nom: 'Os à Moelle', desc: '4 pièces', prix: 6.50, icon: '🦴', stock: 18,
  ...
  },
  {
    ...
    produits: [
      { id: 'g1', nom: "Gigot d'Agneau", desc: '1,2 kg, entier', prix: 28.50, icon: '🍖', stock: 3,
        photo: null, decoupes: ['Entier', 'Désossé', 'En tranches'], preparation: ['Nature', 'Piqué ail', 'Herbes de Provence'] },
      { id: 'ca1', nom: "Carré d'Agneau", desc: '8 côtelettes', prix: 22.00, icon: '🥩', stock: 0,
        photo: null, decoupes: ['Entier', 'Côtelettes séparées'], preparation: ["Nature", "Croûte d'herbes", 'Moutarde'] },
      { id: 'e2', nom: 'Épaule Désossée', desc: '800g, à rôtir', prix: 16.80, icon: '🥩', stock: 7,
        photo: null, decoupes: ['Entière', 'En morceaux navarin'], preparation: ['Nature', 'Ficellée', 'Farcie'] },
      { id: 'm2', nom: 'Merguez Agneau', desc: '8 pièces, maison', prix: 9.90, icon: '🌶️', stock: 25,
  ...
  },
  {
    ...
    badge: 'Promo', ouvert: true,
    produits: [
      { id: 'w1', nom: 'Wagyu A5 – 200g', desc: 'Grade A5, Japon', prix: 58.00, icon: '⭐', stock: 2,
      ...
      { id: 't1', nom: 'T-Bone Maturé 60j', desc: '700g, majestueux', prix: 39.90, icon: '🥩', stock: 4,
        photo: null, decoupes: ['Entier', 'Séparé faux-filet/filet'], preparation: ['Nature', 'Sel de Guérande'] },
      { id: 'rt1', nom: 'Roastbeef Maturé', desc: '600g, tranche fine', prix: 27.50, icon: '🍖', stock: 9,
        photo: null, decoupes: ['En rôti', 'Tranché fin', 'Tranché épais'], preparation: ['Nature', 'Bardé', 'Lardé ail'] },
      { id: 'br1', nom: 'Brisket Fumé', desc: '500g, BBQ style', prix: 19.00, icon: '🔥', stock: 6,
  ...
  },
  {
    ...
    badge: 'Nouveau', ouvert: true,
    produits: [
      { id: 'po1', nom: 'Poulet Fermier Entier', desc: '1,6 kg, plein air', prix: 17.90, icon: '🐓', stock: 11,
        photo: null, decoupes: ['Entier', 'Découpé 8 morceaux', 'Blanc seul'], preparation: ['Nature', 'Mariné citron-thym', 'Farci'] },
      { id: 'la1', nom: 'Lapin Entier', desc: '1,2 kg, élevage', prix: 14.50, icon: '🐇', stock: 0,
        photo: null, decoupes: ['Entier', 'Découpé', 'Râble seul'], preparation: ['Nature', 'Moutarde'] },
      { id: 'ca2', nom: 'Canard Effilé', desc: '1,8 kg', prix: 19.00, icon: '🦆', stock: 5,
        photo: null, decoupes: ['Entier', 'Découpé', 'Magret seul'], preparation: ['Nature', 'Confit'] },
      { id: 'ma1', nom: 'Magret de Canard', desc: '2 pièces, 400g', prix: 16.80, icon: '🍖', stock: 8,
...
export const CATS_NAV = [
  { icon: '🥩', label: 'Bœuf' }, { icon: '🐷', label: 'Porc' },
  { icon: '🐑', label: 'Agneau' }, { icon: '🐔', label: 'Volaille' },
  { icon: '🌭', label: 'Charcuterie' }, { icon: '⭐', label: 'Premium' },
  { icon: '🌿', label: 'Bio' }, { icon: '🔥', label: 'BBQ' },
]
